...
def isWinner(bo, le):
    ...
    return ((bo[7] == le and bo[8] == le and bo[9] == le) or  # across the top row
            ...
            # across the buttom row
            (bo[1] == le and bo[2] == le and bo[3] == le) or
            # across the first column
            (bo[7] == le and bo[4] == le and bo[1] == le) or
            # across middle column
            (bo[8] == le and bo[5] == le and bo[2] == le) or
            # across the buttom column
            (bo[9] == le and bo[6] == le and bo[3] == le) or
            # across the backward diagonal
...
def getPlayerMove(board):
    ...
    # '1 2 3 4 5 6 7 8 9'.split() evaluates to ['1', '2', '3', '4', '5', '6', '7', '8', '9']
    move = ' '
...
def isBoardFull(board):
    ...
    for i in range(1, 10):
        if isSpaceFree(board, i):
            # As soon as for loops finds a free space on the board (that is, when isSpaceFree(board, i)
            return False
...
while True:
    ...
    # The gameIsPlaying variable keeps track of whether the game is still being played or if someone
    gameIsPlaying = True
    # has won or tied.
